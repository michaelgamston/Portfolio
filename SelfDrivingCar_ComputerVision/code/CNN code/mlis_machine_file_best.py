...
class Angle_CNN(): 
    ...
    def __init__(self):
        ...
        model_angle.compile(optimizer='adam',
                    loss=losses.CategoricalCrossentropy(),
                    metrics=['accuracy'])
        model_angle.fit(train_angle, validation_data=val_angle, epochs=150, callbacks=[callback, checkpoint])
        ...
        model_angle.fit(train_angle, epochs=20, callbacks=[callback_rebuild, checkpoint_rebuild], validation_data=val_angle)                            
